...
from binance_extreme_funding.orderbook import estimate_basis_round_trip
...
def latest_opportunities_path(config: BinanceExtremeFundingConfig = DEFAULT_CONFIG) -> Path:
...
def _open_position_watchlist(config: BinanceExtremeFundingConfig) -> dict[str, dict[str, set[float]]]:
