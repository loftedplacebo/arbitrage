...
<nav><button class="tab active" data-tab="funding">Funding</button><button class="tab" data-tab="shortlist">Shortlist</button><button class="tab" data-tab="positions">Positions</button><button class="tab" data-tab="summary">Summary</button></nav>
