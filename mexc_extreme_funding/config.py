...
class MexcExtremeFundingConfig:
    ...
    timed_exit_max_notional_usd: float = 250.0
    timed_exit_max_loss_usd: float = 0.15
    ...
    api_key: str = os.getenv("MEXC_EXTREME_FUNDING_API_KEY", "")
    api_secret: str = os.getenv("MEXC_EXTREME_FUNDING_API_SECRET", "")
